...
function showAlert(message, type = 'info') {
    ...
    alert.style.cssText = `/* ARQV30 Enhanced v3.0 - Interface Moderna Profissional */
...
:root {
    ...
    /* Gradientes Modernos */
    --gradient-primary: linear-gradient(135deg, var(--primary-600), var(--accent-indigo));
    --gradient-secondary: linear-gradient(135deg, var(--accent-teal), var(--accent-emerald));
    --gradient-accent: linear-gradient(135deg, var(--accent-violet), var(--accent-rose));
...
/* Adiciona estilos para controles de análise */
.analysis-controls {
    background: var(--bg-secondary);
    padding: 20px;
    border-radius: 12px;
...
/* Melhora o design da interface com cores modernas */
.analysis-card {
    background: var(--bg-card);
    border: 1px solid var(--border-color);
    border-radius: 16px;
